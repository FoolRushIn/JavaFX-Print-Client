...
public class ResizeHelper {
    ...
    public static double currWidthOfStage = 1200.0;
    public static double currHeightOfStage = 700.0;
    public static double currXOfStage = 0.0;
    public static double currYOfStage = 0.0;
