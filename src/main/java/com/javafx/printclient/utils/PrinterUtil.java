...
//            printer.startThread();
    ...
    public static boolean savePrinter(String printerName, String osprintername) {
        ...
        try {
            ...
            prop.store(oFile, "");
            oFile.close();
            PrinterUtil.addPrinter(printerName, osprintername);
            return true;
    ...
    public static boolean removePrinterAction(String printerName) {
        Properties prop = new Properties();
        File f = new File("printer.properties");
        FileInputStream in = null;
        FileOutputStream oFile = null;
